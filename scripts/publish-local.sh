...
echo "  - com.fatihcure.kolo:core:1.2.0"
echo "  - com.fatihcure.kolo:normalizers:1.2.0"
echo "  - com.fatihcure.kolo:transformers:1.2.0"
echo "  - com.fatihcure.kolo:providers:1.2.0"
echo ""
