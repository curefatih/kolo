...
echo "  - com.fatihcure.kolo:core:1.0.0"
echo "  - com.fatihcure.kolo:normalizers:1.0.0"
echo "  - com.fatihcure.kolo:transformers:1.0.0"
echo "  - com.fatihcure.kolo:providers:1.0.0"
echo ""
