...
echo "  - com.fatihcure.kolo:core:1.1.0"
echo "  - com.fatihcure.kolo:normalizers:1.1.0"
echo "  - com.fatihcure.kolo:transformers:1.1.0"
echo "  - com.fatihcure.kolo:providers:1.1.0"
echo ""
